...
export function PousadaDashboardView({ clientId, role }: { clientId: string; role: "manager" | "client" }) {
  ...
  const [novoTipoCobranca, setNovoTipoCobranca] = useState<CobrancaTipo>("individual");
    ...
    <div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-slate-400">O período escolhido atualiza os totais, a busca e a contagem de cada tipo de reserva.</p>
        </div>
