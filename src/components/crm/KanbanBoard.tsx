...
function PlatformIcon({ lead }: { lead: Lead }) {
  ...
  if (platform === "meta") return <img src="/logos/meta.png" alt="Meta" className="w-3.5 h-3.5 shrink-0 object-contain" />;
  if (platform === "google") return <img src="/logos/google-ads.png" alt="Google Ads" className="w-3.5 h-3.5 shrink-0 object-contain" />;
  if (platform === "tiktok") return <img src="/logos/tiktok.png" alt="TikTok" className="w-3.5 h-3.5 shrink-0 object-contain" />;
  if (platform === "linkedin") return <img src="/logos/linkedin.png" alt="LinkedIn" className="w-3.5 h-3.5 shrink-0 object-contain" />;
                ...
                {colLeads.map((lead) => {
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={() => { if (lead.source === "whatsapp") prefetchConversation(lead.realPhone ?? lead.phone, lead.clientId, lead.funnelId); }}
                    ...
                    >
                      ...
                      <p className="text-xs text-slate-500 mb-2 font-mono">{(() => { const p = (lead.realPhone ?? lead.phone).replace(/\D/g,""); return p.startsWith("55") ? p : "55"+p; })()}</p>
