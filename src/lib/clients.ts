...
export type Client = {
  ...
  pousadaPixChave?: string;     // Chave Pix usada na cobrança automática após o formulário de hóspedes (sistema de Pousada)
  pousadaPixFavorecido?: string; // Nome do favorecido do Pix (sistema de Pousada)
