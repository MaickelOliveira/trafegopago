 ...
 *  Chamada direto do content script (não do service worker) — precisa de
 *  CORS explícito (ver src/lib/extension-cors.ts) ou o navegador bloqueia
